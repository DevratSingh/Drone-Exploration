...
class Planner:
    ...
    def __init__(self, start, goal, iterations, res, inflateradius, obstacles, ext, path_res = 0.2, sample_rate = 5):
    ...
    def findclosestNode(self, vertices, currentNode):
        distances = []
